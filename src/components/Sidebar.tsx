...
const ADMIN_NAV: Array<{ section?: string; href: string; label: string; icon: string }> = [
  ...
  { href: "/expenses", label: "Expenses", icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m10 4H9a2 2 0 01-2-2v-6a2 2 0 012-2h10a2 2 0 012 2v6a2 2 0 01-2 2zm-7-5a2 2 0 11-4 0 2 2 0 014 0z" },
...
const EMPLOYEE_NAV: Array<{ section?: string; href: string; label: string; icon: string }> = [
  ...
  { href: "/me/expenses", label: "My Expenses", icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m10 4H9a2 2 0 01-2-2v-6a2 2 0 012-2h10a2 2 0 012 2v6a2 2 0 01-2 2zm-7-5a2 2 0 11-4 0 2 2 0 014 0z" },
